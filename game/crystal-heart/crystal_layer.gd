...
var time_till_crystalize: float = 20
var crystalization_count_down: float = 20
...
func _process(delta: float) -> void:
	crystalization_count_down= clampf(crystalization_count_down-delta, 0, time_till_crystalize)
	if crystalization_count_down ==0 :
		crystalization_count_down =time_till_crystalize
		crystalize()
	pass
